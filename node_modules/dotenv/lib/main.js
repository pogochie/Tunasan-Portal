...
const subscriptions = []; // In-memory, replace with DB in production
...
// Add modal open/close logic at the end of your main.js or in a new script block
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const openModal = () => {
    ...
    // Optionally reset form and map marker here
    incidentForm.reset();
    // Reset hidden lat/lng inputs
    document.getElementById("lat").value = "";
    document.getElementById("lng").value = "";
    // Reset map view and marker if needed
